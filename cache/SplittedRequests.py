...
class SplittedRequests:
    ...
    @staticmethod
    def create_task_prompt(num_questions, difficulty_eng):
        ...
        base_prompt = MessageBuilder.add_message(
            ...
            [
                ...
                MessageBuilder.add_txt_to_content(PromptBuilder.get_general_guidelines_prompt(difficulty)),
                MessageBuilder.add_txt_to_content(
                    PromptBuilder.get_task_and_example_prompt() + "Erstelle die Aufgabenstellung und ein passendes Beispiel. Stelle sicher, dass diese vollständig und fehlerfrei sind."),
            ]
        )
    ...
    @staticmethod
    def create_state_transition_table_prompt(aufgabenstellung):
    ...
    @staticmethod
    def create_example_flow_table_prompt(aufgabenstellung):
        messages = []
